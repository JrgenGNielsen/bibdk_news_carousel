...
//define("INFOMEDIA_HOST","saba.dbc.dk:21040");
...
$TARGET["infomedia"]= array (
      ...
      "link"           => array ( "anchor" => '<a href=\'javascript:void(0)\' onClick=\'PopWinxy("_HREF_","popup",700,750,100,1)\'>_TEXT_</a>',
...
$TARGET["Danbib"]= array (
    ...
    "sdi_use"        => true,
    "format"        => "vrk_standard",
    "accept_formats"  => array ( "isodm2" => "danmarc/isodm2",
                                 "isodm2_ub" => "danmarc/isodm2_ub",
                                 "stdhentdm2" => "sutrs/stdhentdm2",
                                 "marckopi" => MARC21 . "/F"),
    "formats"        => array ( "vrk_oversigt"          => "xml/np_vrk",
    ...
    "fallback_format"   => array ("vrk_oversigt"          => "single",
                                  "vrk_standard"          => "single",
